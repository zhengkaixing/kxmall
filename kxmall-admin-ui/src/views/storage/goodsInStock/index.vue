<template>
  <div class="app-container">
    <el-form class="query-form" ref="queryForm" :model="queryParams" :inline="true" label-width="80px">
      ...
      <el-form-item label="入库单号" prop="inStockNumbers">
        <el-input
      ...
      <el-form-item label="入库时间" prop="ingoingTime">
        <el-date-picker
    ...
    <stock-list :id="id" :title="title" v-model="open" type="in" :mode="mode" @ok="onOk" />
  </div>
</template>
