			...
			<view class="bg-user-gradual-green">
				...
				<view class="padding-top-lg flex justify-between align-end padding-lr" style="padding-top: 30rpx;">
					<view class="">
						...
						<view v-if="!hasLogin"
						style="width: 162rpx;height: 56rpx;margin-top: 20rpx;background-image: url(http://qiniuoss.nauzone.cn/%E7%BC%96%E7%BB%84%206@3x%20%281%29.png);background-repeat: no-repeat;background-size: 100%;"
						></view>
						<view v-else
						style="width: 162rpx;height: 56rpx;margin-top: 20rpx;background-image: url(http://qiniuoss.nauzone.cn/%E7%BC%96%E7%BB%84%206@3x%20%282%29.png);background-repeat: no-repeat;background-size: 100%;"
						></view>
					</view>
...
<style lang='scss'>
	...
	.bg-user-gradual-green {
	  background-image: url(http://qiniuoss.nauzone.cn/%E7%BC%96%E7%BB%84%2013@3x.png);
